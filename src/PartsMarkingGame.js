  ...
  const translations = {
    english: {
      ...
      descriptions: {
        ...
        acrosome:
          "Enzyme-rich cap that helps sperm penetrate the egg during fertilization",
        nucleus:
          "Contains male genetic material (23 chromosomes) for reproduction",
        "middle piece":
          "Contains mitochondria that provide energy for sperm movement",
        ...
        // Egg descriptions
        "corona radiata":
          "Outermost layer of follicle cells that nourish and protect the egg",
        "zona pellucida":
          "Protective glycoprotein layer that sperm must penetrate for fertilization",
        "cell membrane": "Controls what enters and exits the egg cell",
        cytoplasm:
          "Gel-like substance containing nutrients and organelles for early development",
        nucleolus:
          "Dense region of the nucleus responsible for ribosome production",

        // Eye descriptions
        sclera:
          "Tough white outer layer that protects the eye and maintains its shape",
        retina:
          "Light-sensitive tissue that converts images into electrical signals",
        ...
        "vitreous humor":
          "Clear gel that fills the eye and helps maintain its round shape",
        "optic nerve":
          "Nerve that carries visual information from the retina to the brain",

        // Plant cell descriptions
        "cell wall":
          "Rigid structure that provides support, protection, and shape to plant cells",
        vacuole:
          "Large storage compartment that maintains water pressure and cell rigidity",
        chloroplast:
          "Organelles containing chlorophyll that conduct photosynthesis",

        // Animal cell descriptions
        "endoplasmic reticulum":
          "Network of membranes that transports materials throughout the cell",
        lysosomes:
          "Digestive organelles that break down waste materials and worn-out parts",
        ...
        switch:
          "Device that opens or closes circuits to control the flow of electricity",
        bulb: "Device that converts electrical energy into light energy",
        resistor:
          "Component that opposes current flow and controls the amount of current",

        // Solar system descriptions
        sun: "Central star that provides light and heat energy to all planets",
        earth:
          "Third planet from the sun, our home with water, atmosphere, and life",
    ...
    tamil: {
      ...
      descriptions: {
        ...
        acrosome:
          "கருத்தரிப்பின் போது விந்தணு கருமுட்டையில் ஊடுருவ உதவும் என்சைம் நிறைந்த தொப்பி",
        nucleus:
          "இனப்பெருக்கத்திற்கான ஆண் மரபணு பொருள் (23 குரோமோசோம்கள்) உள்ளது",
        "middle piece":
          "விந்தணு இயக்கத்திற்கு ஆற்றல் வழங்கும் மைட்டோகாண்ட்ரியா உள்ளது",
        tail: "நீச்சல் இயக்கங்கள் மூலம் விந்தணுவை முன்னோக்கி செலுத்தும் நீண்ட கசை",
        mitochondria:
          "விந்தணு இயக்கத்திற்கு ATP ஆற்றலை உற்பத்தி செய்யும் சக்தி நிலையங்கள்",

        // Egg descriptions
        "corona radiata":
          "கருமுட்டையை பேணி பாதுகாக்கும் வெளிப்புற கூட்டு செல் அடுக்கு",
        "zona pellucida":
          "கருத்தரிப்புக்காக விந்தணு ஊடுருவ வேண்டிய பாதுகாப்பு கிளைக்கோபுரத அடுக்கு",
        "cell membrane":
          "கருமுட்டை செல்லுக்குள் என்ன நுழைகிறது மற்றும் வெளியேறுகிறது என்பதைக் கட்டுப்படுத்துகிறது",
        cytoplasm:
          "ஆரம்ப வளர்ச்சிக்கான ஊட்டச்சத்துக்கள் மற்றும் உறுப்புகளைக் கொண்ட ஜெல் போன்ற பொருள்",
        nucleolus:
          "ரைபோசோம் உற்பத்திக்கு பொறுப்பான அணுக்கருவின் அடர்த்தியான பகுதி",

        // Eye descriptions
        sclera:
          "கண்ணைப் பாதுகாத்து அதன் வடிவத்தை பராமரிக்கும் கடினமான வெள்ளை வெளிப்புற அடுக்கு",
        ...
        "vitreous humor":
          "கண்ணை நிரப்பி அதன் வட்ட வடிவத்தை பராமரிக்க உதவும் தெளிவான ஜெல்",
        "optic nerve":
          "விழித்திரையிலிருந்து மூளைக்கு பார்வை தகவலை கொண்டு செல்லும் நரம்பு",

        // Plant cell descriptions
        "cell wall":
          "தாவர செல்களுக்கு ஆதரவு, பாதுகாப்பு மற்றும் வடிவத்தை வழங்கும் கடினமான அமைப்பு",
        vacuole:
          "நீர் அழுத்தத்தையும் செல் கடினத்தன்மையையும் பராமரிக்கும் பெரிய சேமிப்பு பகுதி",
        chloroplast: "ஒளிச்சேர்க்கையை நடத்தும் குளோரோஃபில் கொண்ட உறுப்புகள்",

        // Animal cell descriptions
        "endoplasmic reticulum":
          "செல் முழுவதும் பொருட்களை கொண்டு செல்லும் சவ்வுகளின் வலைப்பின்னல்",
        lysosomes:
          "கழிவு பொருட்கள் மற்றும் தேய்ந்த பாகங்களை உடைக்கும் செரிமான உறுப்புகள்",

        // Circuit descriptions
        wire: "மின்சுற்று வழியே மின்னோட்டம் பாய அனுமதிக்கும் கடத்தி",
        battery: "மின்சுற்றுக்கு மின் ஆற்றலை வழங்கும் சக்தி மூலம்",
        switch:
          "மின்னோட்ட ஓட்டத்தைக் கட்டுப்படுத்த சுற்றுகளைத் திறக்கவோ மூடவோ செய்யும் சாதனம்",
        bulb: "மின் ஆற்றலை ஒளி ஆற்றலாக மாற்றும் சாதனம்",
        resistor:
          "மின்னோட்ட ஓட்டத்தை எதிர்த்து மின்னோட்ட அளவைக் கட்டுப்படுத்தும் கூறு",

        // Solar system descriptions
        sun: "அனைத்து கிரகங்களுக்கும் ஒளி மற்றும் வெப்ப ஆற்றலை வழங்கும் மைய நட்சத்திரம்",
        earth:
          "நீர், வளிமண்டலம் மற்றும் உயிர்களைக் கொண்ட நமது வீடான சூரியனிலிருந்து மூன்றாவது கிரகம்",
        mars: "மேற்பரப்பில் இரும்பு ஆக்சைடு காரணமாக 'சிவப்பு கிரகம்' என்று அழைக்கப்படும் நான்காவது கிரகம்",
        jupiter:
          "பெரிய சிவப்பு புள்ளி புயல் மற்றும் பல நிலவுகளைக் கொண்ட மிகப்பெரிய கிரகம்",
            ...
            >
                ...
                >
                  {React.cloneElement(topics[selectedTopic].diagram, {
                    style: {
                      width: "100%",
                      height: "100%",
                      ...topics[selectedTopic].diagram.props.style,
                    },
                  })}
              ...
              {lastSelectedPart && (
                ...
                >
                  ...
                  >
                    ✓{" "}
                    {(t && t.parts && t.parts[lastSelectedPart]) ||
                      lastSelectedPart}
                  </h4>
                  <p
                    style={{
                  ...
                  >
                    {(t &&
                      t.descriptions &&
                      t.descriptions[lastSelectedPart]) ||
