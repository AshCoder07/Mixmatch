...
const GeographyGame = () => {
  ...
  const [showingAnswers, setShowingAnswers] = useState({ correct: null, wrong: null });
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{
              ...
              <div style={{
                ...
                <div style={{ fontSize: 'min(2.8vh, 2vw)', fontWeight: 'bold' }}>
            ...
            <div style={{
              ...
              <div style={{ fontSize: 'min(2.5vh, 1.8vw)', fontWeight: 'bold' }}>
                {performanceLevel}
              </div>
            </div>
          </div>
          ...
          <div style={{
            ...
            <div style={{
              height: 'calc(100% - 5vh)',
              display: 'grid',
              gridTemplateRows: `repeat(${Math.min(gameResults.length, 8)}, 1fr)`,
              gap: '0.5vh',
              overflow: 'hidden'
            }}>
              {gameResults.slice(0, 8).map((result, index) => (
                <div key={`{${result.question}-${index}}`} style={{
                  ...
                  border: result.correct ? '2px solid rgba(76, 175, 80, 0.3)' : '2px solid rgba(244, 67, 54, 0.3)',
  ...
  // Playing Screen
  const currentMapConfig = getCurrentMapConfig();
  const currentPoint = currentMapConfig.points[currentQuestionIndex] || currentMapConfig.points[0];
            ...
            {showingAnswers.correct && (
              ...
              >
                <div style={{
                  ...
                  border: '3px solid white',
                  boxShadow: `0 4px 15px ${showingAnswers.wrong ? 'rgba(33, 150, 243, 0.5)' : 'rgba(76, 175, 80, 0.5)'}`,
                  display: 'flex',
                  alignItems: 'center',
                  justifyContent: 'center',
                  color: 'white',
